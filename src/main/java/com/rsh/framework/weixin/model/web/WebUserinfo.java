...
public class WebUserinfo {
    ...
    public WebUserinfo(String json) {
        ...
        try {
            ...
            JSONArray privileges = jb.getJSONArray("privilege");
            this.privilege = privileges.toJavaList(String.class);
